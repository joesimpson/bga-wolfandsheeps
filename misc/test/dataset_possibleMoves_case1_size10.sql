-- TEST 2.B (SIZE 10): Test positions and possible moves : 2 black tokens CANNOT MOVE
 
 
 
UPDATE token SET token_location='I5', token_state='1' WHERE token_key = 't_ffffff_1'; 
...
UPDATE token SET token_location='J6', token_state='0' WHERE token_key = 't_000000_4'; 
