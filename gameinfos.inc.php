...
'tie_breaker_description' => totranslate("Number of moves to win"),
//The lowest number gives victory, so the negative number will be multiplied by -1 to display a positive number
'tie_breaker_split' => array( -1 ),
